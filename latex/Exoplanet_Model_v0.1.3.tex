...
%    }
    ...
    \definecolor{linkcolor}{rgb}{.05,.05,.05}  % sections links will be a different black
    \definecolor{citecolor}{rgb}{.15,.15,.15} % citations will be a different black
...
coefficients'' (\cite{Mandel}). In order to produce the
...
discovered in 2007 by \citeauthor*{Fischer} \parencite*{Fischer}, HD 17156b is a relatively cool Hot Jupiter planet slightly smaller than Jupiter. The next page shows a figure containing all the initial parameters for the HD 17156 system (\cite{Nutzman}).
