...
curve are given the diagram below.
...
\section{Exoplanet Case Studies}\label{data-analysis}}
...
Jupiter planet slightly smaller than Jupiter. Below is a table of all
the initial parameters for the planetary system of HD 17156 (Nutzman et
al., 2010).

    \hypertarget{table-4.i}{%
\paragraph{Table 4.I}\label{table-4.i}}
...
\end{tcolorbox}
    ...
    \hypertarget{transit}{%
\subsubsection{Transit}\label{transit}}
